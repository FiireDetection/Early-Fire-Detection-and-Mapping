"""
Alarm state machine for training-time sequence metrics.

This module keeps the model_egitimi package self-contained. It is intentionally
small because the full video inference pipeline will be added separately.
"""
...
class AlarmStateMachine:
    ...
    It reduces single-frame spikes by requiring consecutive high-confidence
    predictions before reporting a confirmed alarm.
    """
    ...
    def update(
        ...
        """
        Apply hysteresis and persistence to one prediction.

        Returns:
            state, event flag, confidence, reason string
        """
        reasons: list[str] = []
